...
export function WhatsAppButton({ message = 'Hello, I have a query about Alleppey Tourism!', phone = '919567296056' }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center group"
