...
export function ListingGrid({ items, className, scrollable = false }: ListingGridProps) {
  ...
  const scrollContainerClasses =
    'flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory scrollbar-hide -mx-4 px-4 scroll-pl-4 sm:gap-6 sm:mx-0 sm:px-0 sm:scroll-pl-0';
          ...
          >
            <Link href={item.href} className="block h-full w-full cursor-pointer">
              ...
              <div className="relative aspect-square bg-gray-200 rounded-xl overflow-hidden mb-3">
                ...
                {/* Favorite Button */}
                <button className="absolute top-3 right-3 p-1.5 hover:scale-110 transition-transform z-10 pointer-events-auto">
