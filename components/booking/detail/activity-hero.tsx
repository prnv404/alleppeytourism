    ...
    return (
        <div className="relative w-full mb-8">
            <div className="relative w-full h-[60vh] md:h-[70vh] min-h-[450px] max-h-[800px] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-xl md:shadow-2xl bg-black group">
                ...
                {/* Back Button */}
                <Link href="/houseboats" className="absolute top-6 left-6 md:top-8 md:left-8 z-30 flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 text-white px-4 py-2 md:px-5 md:py-2.5 rounded-full text-xs md:text-sm font-bold hover:bg-white hover:text-black transition-all">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-16 z-20 pointer-events-none pb-12 md:pb-16">
                    ...
                    >
                        <div className="flex items-center gap-2 md:gap-3 text-amber-400 mb-3 md:mb-4">
                            <span className="bg-amber-400 text-black text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Premium</span>
