      ...
      <div className="flex items-start justify-between">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <span className="px-3 py-1 bg-black text-white text-[10px] font-bold uppercase tracking-[0.2em]">Signature</span>
          ...
          <h1 className="text-6xl font-black text-gray-900 tracking-tighter leading-[1.1]">{activity.name}</h1>
