import { Users, Bed, Ship, ChefHat, ShieldCheck, Languages, Sparkles, Star } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {specs.map((spec, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-gray-50/80 p-4 rounded-2xl border border-gray-100 flex items-start gap-3 hover:border-emerald-100 transition-colors"
              >
                ...
                <div className="flex flex-col pt-0.5">
                  ...
                  <span className="text-[10px] uppercase tracking-wide text-gray-500 font-medium leading-tight mt-1">
                    {spec.label}
                  </span>
                </div>
              </div>
    ...
    <div className="mb-8">
      ...
      <div className="flex gap-3 overflow-x-auto pb-4 -mx-5 px-5 md:mx-0 md:px-0 scrollbar-hide snap-x snap-mandatory">
        {features?.map((feature, idx) => (
          <div
            key={idx}
            className="min-w-[140px] md:min-w-[160px] snap-center bg-gray-50 p-4 rounded-xl border border-gray-100 flex flex-col items-center text-center gap-3 hover:border-emerald-200 hover:shadow-md transition-all group"
          >
