        ...
        <div className="hidden lg:block lg:w-[380px] lg:shrink-0 transition-all duration-300 z-20">
            <div className="">
                <div className="bg-white rounded-[1rem] shadow-xl border border-gray-100 p-6 ring-1 ring-gray-900/5">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-gray-500 mt-1">
                                {activity.type === "houseboat"
                                    ? `per boat / ${stayType === 'day' ? 'cruise' : 'night'}`
                                    : "per person"
                                }
                            </p>
                        </div>
                    ...
                    {activity.type === "houseboat" ? (
                        <div className="mb-6">
                            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 block">Select Experience</label>
                            <div className="flex gap-2">
                                {(Object.keys(CRUISE_TYPES) as StayType[]).map((type) => (
                                    ...
                                    >
                                        {type === 'overnight' ? 'Overnight' : CRUISE_TYPES[type].label}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 block">Select Duration</label>
