                ...
                <div className="flex gap-3 overflow-x-auto pb-2 -mx-5 px-5 snap-x snap-mandatory scrollbar-hide">
                    {activity.type === "houseboat" ? (
                        (Object.keys(CRUISE_TYPES) as StayType[]).map((type) => {
                            ...
                            const schedule = schedules.find(s => s.id === (type === 'overnight' ? 'overnight' : type === 'day' ? 'day' : 'night'));
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-end justify-between mt-2">
                                        ...
                                        <div className="text-[10px] bg-gray-100 px-1.5 py-0.5 rounded text-gray-500 font-medium">
                                            Details &gt;
                                        </div>
                                    </div>
                                </div>
                        ...
                        return (
                            <>
                                ...
                                <div className={cn("relative p-5 pb-8 overflow-hidden", item.bg.replace('50', '50'))}>
                                    <div className={cn("absolute -top-10 -right-10 w-32 h-32 rounded-full opacity-20", item.bg.replace('50', '200'))} />

                                    <div className="relative z-10 flex items-start gap-4">
                                        <div className={cn("inline-flex items-center justify-center p-2.5 rounded-xl bg-white/80 backdrop-blur shadow-sm shrink-0")}>
                                            <item.icon className={cn("w-5 h-5", item.color)} />
                                        </div>
                                        <div>
                                            <DialogTitle className="text-xl font-black text-gray-900 leading-none mb-1">{item.title}</DialogTitle>
                                            <p className="text-xs text-gray-600 font-medium leading-snug max-w-[200px]">
                                                {item.description}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {item.meals.map((meal, idx) => (
                                                <span key={idx} className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-50 border border-gray-100 text-[10px] font-bold text-gray-700">
