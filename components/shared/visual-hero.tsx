                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between py-6 gap-6">
                        ...
                        {stats && (
                            <div className="grid grid-cols-2 gap-4 w-full md:flex md:w-auto md:gap-16">
                                {stats.map((stat, idx) => (
                                    <div key={idx} className="flex items-center gap-3 text-white p-3 md:p-0 bg-white/5 md:bg-transparent rounded-xl md:rounded-none">
                        ...
                        <div className="flex flex-row items-center justify-between gap-4 w-full md:w-auto md:justify-end border-t border-white/10 pt-4 md:border-t-0 md:pt-0 mt-2 md:mt-0">
                            ...
                            <Button size="lg" className="flex-1 md:flex-none h-12 md:h-14 rounded-full bg-white text-black hover:bg-emerald-500 hover:text-white border-0 font-bold px-6 shadow-xl transition-all text-sm md:text-base uppercase tracking-wide">
                                Book Now
                            </Button>
                        </div>
                    </div>
