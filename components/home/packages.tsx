        ...
        <section className="py-8 bg-white border-t border-gray-100">
            <div className="max-w-5xl mx-auto px-4 md:px-6">
                ...
                <div className="text-center mb-7">
                    ...
                    <p className="text-gray-500 text-sm mt-2">Select Houseboat cruise, Shikara tours, Speed Boat rides or kayaking to calculate your total package cost.</p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 w-full space-y-6">
                            ...
                            {activities.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-colors ${isSelected ? 'bg-emerald-500 border-emerald-500' : 'border-gray-300'}`}>
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-6">Sightseeing Add-ons</h3>
