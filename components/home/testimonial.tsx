...
const testimonials = [
  {
    ...
    name: 'Sarah & Tom',
    location: 'London, UK',
    tripImage: '/images/houseboats/houseboat-hero.jpg',
    userImage: '/images/houseboats/houseboat-hero.jpg',
    rating: 5,
    review:
      'Waking up to the sunrise over the backwaters was pure magic. The houseboat was luxurious and the food was incredible.',
  ...
  },
  {
    ...
    location: 'Mumbai',
    tripImage: '/images/shikara/shikara-hero.jpg',
    userImage: '/images/shikara/shikara-hero.jpg',
    rating: 5,
  ...
  },
  {
    ...
    name: "Elena's Group",
    location: 'Spain',
    tripImage: '/images/kayak/kayak-hero.jpg',
    userImage: '/images/kayak/kayak-hero.jpg',
    rating: 5,
  ...
  },
  {
    ...
    name: 'David Chen',
    location: 'Singapore',
    tripImage: '/images/houseboats/IMG-20241008-WA0006.jpg',
    userImage: '/images/houseboats/IMG-20241008-WA0006.jpg',
    rating: 4,
  ...
  },
  {
    ...
    name: 'James & Alisha',
    location: 'Dubai',
    tripImage: '/images/kayak/IMG-20251212-WA0001.jpg',
    userImage: '/images/kayak/IMG-20251212-WA0001.jpg',
    rating: 5,
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-8 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight mb-2">
              Top Rated Alleppey Houseboat & Tour Services
            </h2>
            <p className="text-gray-500 text-sm md:text-base">
              Discover why 500+ happy families rate us as the best boating service in Kerala.
            </p>
          </div>
                  ...
                  <div className="p-5 flex flex-col flex-grow relative">
                    ...
                    <div className="flex gap-0.5 mb-3">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`w-3.5 h-3.5 ${i < item.rating ? 'text-amber-400 fill-amber-400' : 'text-gray-200'}`}
                        />
                      ))}
                    </div>

                    <p className="text-gray-700 text-sm leading-relaxed mb-4 font-medium line-clamp-3">"{item.review}"</p>
                    ...
                    <div className="mt-auto flex items-center gap-2.5 pt-4 border-t border-gray-50">
                      <div className="relative w-8 h-8 rounded-full overflow-hidden border border-gray-100">
                        <Image src={item.userImage} alt={item.name} fill className="object-cover" />
                      </div>
                      <div>
