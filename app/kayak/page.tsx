...
export const metadata: Metadata = {
    ...
    description: "Experience the thrill of kayaking through Alleppey's serene backwaters. Navigate narrow canals and explore village life.",
    keywords: ["kayaking alleppey", "backwater kayaking", "alleppey adventures"],
};

export default function KayakPage() {
    const activity = activities.find((a) => a.id === "kayak");
            ...
            <div className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="max-w-4xl">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed mb-8">
                        Paddle through the silent backwater canals where large houseboats cannot reach.
                        Witness the authentic village life of Kuttanad from water level.
                    </p>
                    ...
                    <div className="md:col-span-7 space-y-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {activity.durations?.map((d) => {
                                    ...
                                    return (
                                        <div key={d.id} className={`group relative flex items-center justify-between p-6 rounded-xl border transition-all hover:bg-gray-50 ${isPopular ? 'border-emerald-500 ring-1 ring-emerald-500 bg-emerald-50/10' : 'border-gray-200'}`}>
                                            <div className="flex items-center gap-4">
                                                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${isPopular ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-600'}`}>
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <Button asChild size="lg" className={`${isPopular ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-gray-900 hover:bg-black'} text-white rounded-lg`}>
                        ...
                        <div>
                            ...
                            <div className="prose prose-lg text-gray-600">
                                <p className="mb-6">
                                    Kayaking offers a level of intimacy with the backwaters that no other vessel can match.
                                    You govern your own pace, gliding silently past sleepy villages, duck farms, and endless paddy fields.
                                </p>
                                <p>
                                    Our guided tours are beginner-friendly. We use stable, sit-on-top kayaks that are impossible to sink and easy to maneuver.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="py-8 md:py-12 border-y border-gray-100 my-8">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <h3 className="text-3xl font-bold leading-tight">When the water turns <br /><span className="text-gray-400">into liquid gold.</span></h3>
                                    <p className="text-gray-600 leading-relaxed">
                                        There is a specific magic that happens at 6:00 AM on the backwaters. The mist still clings to the water surface, and the only sound is the rhythmic splash of your paddle.
                                    </p>
                                    <p className="text-gray-600 leading-relaxed">
                                        As the sun peeks over the coconut palms, the entire canal lights up in hues of orange and gold. Kingfishers dive for their breakfast, and the village slowly wakes up. This isn't just a tour; it's a meditation in motion.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="py-8 md:py-12 border-b border-gray-100 mb-8 md:mb-12">
                            ...
                            <div className="space-y-8 relative before:absolute before:left-[7px] before:top-2 before:h-full before:w-[2px] before:bg-gray-100">
                                {[
                                    { time: "06:00 AM", title: "Meet & Greet", desc: "Meet your guide at the starting point. Quick safety briefing and life jacket fitting." },
                                    { time: "06:15 AM", title: "Paddle Out", desc: "Launch into the broad channels as the sun begins to rise." },
                                    { time: "07:00 AM", title: "Enter the Canals", desc: "Navigate into the narrow village canals. Silence, birds, and village life." },
                                    { time: "08:00 AM", title: "Tea Break", desc: "Stop at a small local tea shop on the banks for chai and snacks (optional)." },
                                    { time: "09:00 AM", title: "Return", desc: "Paddle back to the finish point with a camera full of memories." }
                                ].map((item, i) => (
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4">
                                {[
                                    { q: "Is it safe for non-swimmers?", a: "Absolutley. Our kayaks are extremely stable sit-on-top models that don't sink. You are also required to wear a high-buoyancy life jacket at all times." },
                                    { q: "Will I get wet?", a: "Expect a few splashes from the paddle, so your shorts might get damp. We recommend carrying a change of clothes just in case." },
                                    { q: "Can kids join?", a: "Children above 6 years are welcome! They can sit in the front seat of a double kayak with a parent or guide." },
                                    { q: "Is there a weight limit?", a: "Our single kayaks support up to 110kg, and double kayaks up to 230kg combined." }
                                ].map((faq, i) => (
                    ...
                    <div className="md:col-span-5 relative">
                        <div className="sticky top-24 space-y-8">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-4 mb-8">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <p className="text-sm text-gray-300 leading-relaxed">
                                                100% Safety Record. Certified lifeguards on duty.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="relative aspect-square rounded-3xl overflow-hidden">
                                <Image src="/images/hero-1.jpg" alt="Atmosphere" fill className="object-cover" />
                            </div>
                        </div>
                    </div>
                </div>
