...
export const metadata: Metadata = {
    ...
    description: "Book premium private houseboats or budget-friendly shared stays in Alleppey backwaters. Experience the Venice of the East.",
};

export default function HouseboatsPage() {
    const houseboatActivities = activities.filter(a => a.type === "houseboat");

    const allHouseboats = houseboatActivities.flatMap(activity => {
        return (activity.variants || []).map(v => ({
            ...v,
            parentImage: activity.image,
            parentId: activity.id,
            parentDesc: activity.description
        }));
    });
        ...
        <div className="bg-white min-h-screen font-sans text-gray-900 selection:bg-emerald-100 selection:text-emerald-900">
            ...
            <section id="private" className="max-w-7xl mx-auto px-6 mb-12 md:mb-20 scroll-mt-24">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {privateBoats.map((boat) => (
                        <div key={boat.id} className="group flex flex-col h-full bg-white border border-gray-200 rounded-3xl overflow-hidden hover:shadow-xl hover:border-emerald-500/30 transition-all duration-300">
                            {/* Image & Price Overlay */}
                            <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                                ...
                                <div className="absolute top-4 right-4 bg-gray-900/90 backdrop-blur-md text-white px-4 py-2 rounded-2xl shadow-lg border border-white/10">
                                    <div className="text-xs text-gray-300 font-medium uppercase tracking-wider text-right">Starts at</div>
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto">
                                    <Button asChild className="w-full bg-black hover:bg-emerald-600 text-white rounded-2xl h-12 font-bold shadow-lg shadow-gray-200 group-hover:shadow-emerald-200 transition-all">
                                    ...
                                    <p className="text-[10px] text-center text-gray-400 mt-3 font-medium">Free Cancellation • Instant Confirmation</p>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <section className="bg-gray-100 py-12 md:py-16 mb-12 md:mb-20 rounded-3xl mx-4 md:mx-6 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 space-y-4">
                        ...
                        <h2 className="text-3xl font-black text-gray-900">Experience <span className="text-emerald-600">Premium</span></h2>
                        <p className="text-gray-600 leading-relaxed font-medium">
                            Our houseboats aren't just transport. They are floating luxury hotels.
                            With dedicated chefs, ensuite bathrooms, and premium bedding, we ensure your stay is as comfortable as it is memorable.
                        </p>
                    </div>
            ...
            <section className="max-w-3xl mx-auto px-6 mb-12 md:mb-20">
                ...
                <div className="grid gap-4">
                    {[
                        { q: "Is food included in the price?", a: "Yes! All meals (Lunch, Tea/Snacks, Dinner, Breakfast) are included in the package. The cuisine is authentic Kerala style." },
                        { q: "What is the check-in time?", a: "Standard check-in is at 12:00 PM and check-out is at 09:00 AM the next morning." },
                    ].map((item, i) => (
