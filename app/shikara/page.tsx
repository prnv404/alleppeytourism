...
export default function ShikaraPage() {
    const activity = activities.find((a) => a.id === "shikara");
            ...
            <div className="relative pt-10 pb-8 md:pt-24 md:pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="max-w-4xl">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed mb-8">
                        Drift silently through narrow canals on a traditional roofed canoe.
                        The perfect blend of comfort and intimacy with nature.
                    </p>
                    ...
                    <div className="md:col-span-7 space-y-12">
                        ...
                        <div>
                            ...
                            <div className="prose prose-lg text-gray-600">
                                <p className="mb-6">
                                    A Shikara is a traditional wooden canoe equipped with comfortable seating and a roof for shade.
                                    Unlike large houseboats, the Shikara is nimble enough to enter the smallest canals where true village life unfolds.
                                </p>
                                <p>
                                    It’s mesmerizingly quiet. Without a heavy diesel engine thrumming, you can hear the birds, the water, and the wind in the palms.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="py-8 md:py-12 border-y border-gray-100 my-8">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div className="space-y-6 order-2 md:order-1">
                                    ...
                                    <h3 className="text-3xl font-bold leading-tight">Where clocks <br /><span className="text-gray-400">have no meaning.</span></h3>
                                    <p className="text-gray-600 leading-relaxed">
                                        In Kuttanad, life moves at the speed of a drifting canoe. You'll pass by ancient temples, see children rowing to school, and watch toddy tappers climbing coconut trees.
                                    </p>
                                    <p className="text-gray-600 leading-relaxed">
                                        The Shikara grants you a front-row seat to this unhurried way of life. It isn't just sightseeing; it's witnessing a living culture that has survived for centuries.
                                    </p>
                                </div>
                        ...
                        <div className="py-8 md:py-12 border-b border-gray-100 mb-8 md:mb-12">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                {[
                                    ...
                                    { title: "Chavara Bhavan", desc: "Ancestral home of Saint Kuriakose Elias Chavara, accessed by boat." },
                        ...
                        <div className="mb-12">
                            ...
                            <div className="space-y-4">
                                {[
                                    { q: "Is food included?", a: "No, but we can stop at riverside restaurants or toddy shops where you can buy fresh seafood and meals." },
                                    { q: "Is there a toilet on board?", a: "Most shikaras do not have toilets due to their small size, but we can make stops at clean facilities upon request." },
                                    { q: "Is it sunny/hot?", a: "The boat has a roof which provides full shade. The open sides allow a constant cool breeze, making it very comfortable even at noon." }
                                ].map((faq, i) => (
